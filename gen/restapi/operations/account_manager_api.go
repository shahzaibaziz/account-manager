...
// NewAccountManagerAPI creates a new AccountManager instance
func NewAccountManagerAPI(spec *loads.Document) *AccountManagerAPI {
	return &AccountManagerAPI{
		...
		ServiceSaveUserHandler: service.SaveUserHandlerFunc(func(params service.SaveUserParams) middleware.Responder {
...
/*AccountManagerAPI the account manager API */
type AccountManagerAPI struct {
	...
	// ServiceSaveUserHandler sets the operation handler for the save user operation
	ServiceSaveUserHandler service.SaveUserHandler
...
func (o *AccountManagerAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *AccountManagerAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *AccountManagerAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *AccountManagerAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *AccountManagerAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *AccountManagerAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *AccountManagerAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *AccountManagerAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *AccountManagerAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the AccountManagerAPI
func (o *AccountManagerAPI) Validate() error {
	...
	if o.ServiceSaveUserHandler == nil {
		unregistered = append(unregistered, "service.SaveUserHandler")
	}
...
func (o *AccountManagerAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *AccountManagerAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *AccountManagerAPI) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *AccountManagerAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *AccountManagerAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *AccountManagerAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the account manager API
func (o *AccountManagerAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *AccountManagerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/user"] = service.NewSaveUser(o.context, o.ServiceSaveUserHandler)
...
func (o *AccountManagerAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *AccountManagerAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *AccountManagerAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *AccountManagerAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
